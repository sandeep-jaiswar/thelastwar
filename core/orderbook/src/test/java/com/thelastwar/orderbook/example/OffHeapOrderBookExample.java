...
public class OffHeapOrderBookExample {
    ...
    private static void bondExample() {
        ...
        book.addOrder(new Order(1L, "US10Y", Order.SIDE_BUY, 9500L, 10_000_000L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(2L, "US10Y", Order.SIDE_BUY, 9490L, 5_000_000L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
        
        book.addOrder(new Order(3L, "US10Y", Order.SIDE_SELL, 9510L, 8_000_000L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(4L, "US10Y", Order.SIDE_SELL, 9520L, 12_000_000L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
    ...
    private static void derivativeExample() {
        ...
        book.addOrder(new Order(1L, "ES_MAR25", Order.SIDE_BUY, 450000L, 10L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(2L, "ES_MAR25", Order.SIDE_BUY, 449500L, 15L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
        
        book.addOrder(new Order(3L, "ES_MAR25", Order.SIDE_SELL, 450500L, 12L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(4L, "ES_MAR25", Order.SIDE_SELL, 451000L, 20L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
    ...
    private static void highFrequencyExample() {
        ...
        for (long i = 1; i <= 1000; i++) {
            ...
            book.addOrder(new Order(i, "GOOGL", side, price, 100L, System.nanoTime(), Order.TYPE_LIMIT, Order.TIF_GTC));
        }
    ...
    private static void marketDepthExample() {
        ...
        book.addOrder(new Order(1L, "MSFT", Order.SIDE_BUY, 37500L, 100L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(2L, "MSFT", Order.SIDE_BUY, 37500L, 200L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(3L, "MSFT", Order.SIDE_BUY, 37400L, 300L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(4L, "MSFT", Order.SIDE_BUY, 37300L, 150L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(5L, "MSFT", Order.SIDE_BUY, 37200L, 250L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        
        // Ask side (lowest to highest)
        book.addOrder(new Order(6L, "MSFT", Order.SIDE_SELL, 37600L, 120L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(7L, "MSFT", Order.SIDE_SELL, 37600L, 180L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(8L, "MSFT", Order.SIDE_SELL, 37700L, 200L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(9L, "MSFT", Order.SIDE_SELL, 37800L, 350L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
        book.addOrder(new Order(10L, "MSFT", Order.SIDE_SELL, 37900L, 400L, timestamp++, Order.TYPE_LIMIT, Order.TIF_GTC));
