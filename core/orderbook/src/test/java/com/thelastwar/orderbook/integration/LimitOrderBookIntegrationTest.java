...
class LimitOrderBookIntegrationTest {
    ...
    void testSimpleMarketMaking() {
        ...
        book.addOrder(new Order(1L, "AAPL", Order.SIDE_BUY, midPrice - spread, 100L, System.nanoTime()));
        book.addOrder(new Order(2L, "AAPL", Order.SIDE_BUY, midPrice - spread * 2, 100L, System.nanoTime()));
        book.addOrder(new Order(3L, "AAPL", Order.SIDE_BUY, midPrice - spread * 3, 100L, System.nanoTime()));
        
        // Place sell orders above mid
        book.addOrder(new Order(4L, "AAPL", Order.SIDE_SELL, midPrice + spread, 100L, System.nanoTime()));
        book.addOrder(new Order(5L, "AAPL", Order.SIDE_SELL, midPrice + spread * 2, 100L, System.nanoTime()));
        book.addOrder(new Order(6L, "AAPL", Order.SIDE_SELL, midPrice + spread * 3, 100L, System.nanoTime()));
    ...
    void testOrderCancellations() {
        // Add multiple orders
        for (long i = 1; i <= 10; i++) {
            book.addOrder(new Order(i, "AAPL", Order.SIDE_BUY, 15000L - i * 10, 100L, System.nanoTime()));
        }
    ...
    void testOrderModifications() {
        ...
        book.addOrder(new Order(2L, "AAPL", Order.SIDE_BUY, 14990L, 100L, System.nanoTime()));
    ...
    void testHighVolumeOrderFlow() {
        ...
        for (int i = 1; i <= orderCount; i++) {
            ...
            book.addOrder(new Order(i, "AAPL", side, price, 100L, System.nanoTime()));
        }
    ...
    void testPriceTimePriorityWithMultipleOrders() {
        ...
        for (long i = 1; i <= 5; i++) {
            book.addOrder(new Order(i, "AAPL", Order.SIDE_BUY, price, 100L, i * 1000L));
        }
    ...
    void testRealisticTradingScenario() {
        ...
        book.addOrder(new Order(1L, "AAPL", Order.SIDE_BUY, 14990L, 500L, System.nanoTime()));
        book.addOrder(new Order(2L, "AAPL", Order.SIDE_BUY, 14980L, 300L, System.nanoTime()));
        book.addOrder(new Order(3L, "AAPL", Order.SIDE_SELL, 15010L, 500L, System.nanoTime()));
        book.addOrder(new Order(4L, "AAPL", Order.SIDE_SELL, 15020L, 300L, System.nanoTime()));
        
        assertEquals(20L, book.getSpread());
        
        // 2. Aggressive buyer improves best bid
        book.addOrder(new Order(5L, "AAPL", Order.SIDE_BUY, 15000L, 200L, System.nanoTime()));
        assertEquals(15000L, book.getBestBid());
    ...
    void testStressTestRandomOrders() {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            if (action < 60 && book.getOrderCount() < 1000) {
                ...
                book.addOrder(new Order(orderId++, "AAPL", side, price, quantity, System.nanoTime()));
